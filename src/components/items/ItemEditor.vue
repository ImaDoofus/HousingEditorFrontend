...
export default {
	...
	data() {
		return {
			...
			item: {},
			enchantments: [
				{ name: 'Protection', level: 0 }, { name: 'Fire Protection', level: 0 }, { name: 'Feather Falling', level: 0}, { name: 'Blast Protection', level: 0 }, { name: 'Projectile Protection', level: 0 }, { name: 'Respiration', level: 0 }, { name: 'Aqua Affinity', level: 0 }, { name: 'Thorns', level: 0 }, { name: 'Depth Strider', level: 0 }, { name: 'Sharpness', level: 0 }, { name: 'Smite', level: 0 }, { name: 'Bane of Arthropods', level: 0 }, { name: 'Knockback', level: 0 }, { name: 'Fire Aspect', level: 0 }, { name: 'Looting', level: 0 }, { name: 'Efficiency', level: 0 }, { name: 'Silk Touch', level: 0 }, { name: 'Unbreaking', level: 0 }, { name: 'Fortune', level: 0 }, { name: 'Power', level: 0 }, { name: 'Punch', level: 0 }, { name: 'Flame', level: 0 }, { name: 'Infinity', level: 0 }, { name: 'Luck of the Sea', level: 0 }, { name: 'Lure', level: 0 },
			],
			enchantmentRules: [
			...
			count: 0,
			countRules: [
				v => v >= 1 || 'Count must be greater than or equal to 1',
				v => v <= 64 || 'Count must be less than or equal to 64',
			],
