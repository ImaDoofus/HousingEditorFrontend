	...
	mounted() {
		...
		Blockly.Blocks["give_item"] = {
			init: function () {
				...
				this.appendValueInput("ITEM")
					...
					.appendField("Item:");
				this.appendDummyInput()
					.appendField('Allow Multiple')
					.appendField(new Blockly.FieldCheckbox("FALSE"), "ALLOW_MULTIPLE");
		...
		Blockly.Blocks["use_inventory_slot"] = {
			init: function () {
				...
				this.appendDummyInput()
					...
					.appendField(new Blockly.FieldImage('assets/table-large-plus.svg', 24, 24, "+", function () {
		...
		Blockly.Blocks['apply_inventory_layout'] = {
			init: function() {
				...
				this.appendDummyInput()
					.appendField('Layout Name')
					.appendField(new Blockly.FieldTextInput('name'), 'LAYOUT');
				this.setPreviousStatement(true, 'action');
				this.setNextStatement(true, 'action');
				this.setColour(320);
